...
import { Play, Heart, MessageCircle, Share2, Volume2, VolumeX, ExternalLink, X, CheckCircle, Flame, Filter } from 'lucide-react';
import { REELS_DATA } from '../data/mockData';
import InstagramIcon from './InstagramIcon';

const CATEGORIES = ['All', 'Viral', 'Tech', 'Design', 'Lifestyle'];
...
export default function ReelsSection() {
  ...
  return (
    <section id="reels" className="py-20 md:py-32 relative">
      ...
      <div className="absolute top-1/2 left-0 w-96 h-96 bg-purple-600/10 rounded-full blur-[150px] pointer-events-none -z-10" />
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        ...
        >
          <div className="inline-flex items-center gap-2 px-4 py-1.5 rounded-full bg-pink-500/10 border border-pink-500/20 text-pink-300 text-xs font-bold uppercase tracking-widest mb-4">
            ...
            <span>Viral Media Feed</span>
          </div>

          <h2 className="text-3xl sm:text-5xl font-extrabold text-white tracking-tight">
            Featured <span className="text-gradient-insta">Instagram Reels</span> & Posts
          </h2>
          
          <p className="mt-4 text-slate-300 max-w-xl text-base sm:text-lg">
            Experience our top-trending short-form videos with interactive momentum scrolling and instant reel previews.
          </p>
                ...
                >
                  {active && (
                    <motion.div
                      ...
                      className="absolute inset-0 bg-gradient-to-r from-indigo-600 to-pink-600 rounded-xl shadow-md -z-10"
          ...
          >
            {filteredReels.map((reel, index) => (
              ...
              >
                ...
                {/* Reel Thumbnail Preview Aspect 4:5 */}
                <div className="relative aspect-[9/14] w-full overflow-hidden bg-slate-950">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <motion.div
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="w-14 h-14 rounded-full bg-white/20 backdrop-blur-md border border-white/40 flex items-center justify-center text-white shadow-xl group-hover:bg-gradient-to-tr group-hover:from-indigo-600 group-hover:to-pink-500 transition-all duration-300"
                    >
                ...
                <div className="p-5 bg-slate-950/90 flex flex-col gap-3">
                  ...
                  <div className="flex items-center justify-between pt-2 border-t border-white/10">
                    ...
                    <a
                      ...
                      className="inline-flex items-center gap-1.5 px-4 py-2 rounded-xl bg-gradient-to-r from-indigo-500 to-pink-500 text-white text-xs font-bold hover:shadow-lg transition-all"
                    >
